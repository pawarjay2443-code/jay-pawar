      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="mailto:pawarjay2443@gmail.com" className="text-neutral-400 hover:text-black transition-colors" aria-label="Email">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-black transition-colors" aria-label="LinkedIn">
